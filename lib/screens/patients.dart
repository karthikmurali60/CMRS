...
class Hospital_Patients extends StatefulWidget {
  static const String id = 'inputpage_screen';
  @override
  _Hospital_PatientsState createState() => _Hospital_PatientsState();
}

class _Hospital_PatientsState extends State<Hospital_Patients> {
  ...
  void sendData() async {
    ...
    _firestore.collection('hospital_patients').document(patient).setData({
      'user_id': uid,
      'age': age,
      'gender': gender,
      'name': patient,
    ...
    _firestore.collection('hospital_patients');
  }
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: kTextFieldInputDecoration8,
                        onChanged: (value) {
                          description = value;
                          print(value);
                        },
